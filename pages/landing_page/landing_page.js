const axiosInstance = axios.create({
  baseURL: 'https://192.168.1.120/quotes_api',
  timeout: 2000
});
...
const errorDetails = document.querySelector('.error-modal .error-wrapper .error-details');
...
const tryAgainBtn = document.querySelector('.error-modal .error-wrapper .try-again');
...
const bigQuotePopularityCount = document.querySelector('.big-quote .popularity-count');
...
function loadRandomQuote() {
  ...
  axiosInstance.get('/quotes/random').then( (res) => {
...
function adjustContentFontSize(contentLength) {
  ...
  // console.log(contentLength, bigQuoteContent.classList);
}
...
function toggleModal() {
  ...
  copiedIndicator.src = 'https://fonts.gstatic.com/s/i/googlematerialicons/content_copy/v16/gm_grey200-24dp/1x/gm_content_copy_gm_grey200_24dp.png';
}
...
function copiedShareUrl() {
  copiedIndicator.src = 'https://fonts.gstatic.com/s/i/googlematerialicons/done/v15/gm_grey200-24dp/1x/gm_done_gm_grey200_24dp.png';
}
...
function toggleNextQuoteBtnAnimation() {
  ...
  setTimeout(() => {nextQuoteBtn.classList.toggle('clicked')}, 1600);
}
...
function init() {
  ...
  shareQuoteBtn.addEventListener('click', (e) => shareCurrentQuote(e, 'quote')());
